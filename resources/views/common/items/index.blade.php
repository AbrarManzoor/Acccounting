                ...
                <table class="table table-flush table-hover">
                    <thead class="thead-light">
                        <tr class="row table-head-line">
                            ...
                            <th class="col-xs-2 col-sm-2 col-md-2 col-lg-3 col-xl-2">@sortablelink('name', trans('general.name'), ['filter' => 'active, visible'], ['class' => 'col-aka', 'rel' => 'nofollow'])</th>
                            <th class="col-lg-1 col-xl-1 d-none d-lg-block">@sortablelink('make', trans_choice('Make', 1))</th>
                            <th class="col-lg-1 col-xl-2 d-none d-lg-block">@sortablelink('make', trans_choice('Vin', 1))</th>
                    ...
                    <tbody>
                        @foreach($items as $item)
                            <tr class="row align-items-center border-top-1">
                                ...
                                <td class="col-xs-2 col-sm-2 col-md-2 col-lg-2 col-xl-2 py-2">
