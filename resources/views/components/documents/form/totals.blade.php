                ...
                @stack('grand_total_td_start')
                    <tr id="tr-total">
                        ...
                        <td class="text-right border-top-0 border-right-0 align-middle pt-0 pb-0 pr-0">
                            <strong class="document-total-span">{{ trans('invoices.accounts') }}</strong>
                            {{ Form::selectGroup('id', '', '', $accounts, setting('default.currency'), ['required' => 'required', 'model' => 'form.currency_code', 'change' => 'onChangeCurrency'], 'document-total-currency') }}
                        </td>
