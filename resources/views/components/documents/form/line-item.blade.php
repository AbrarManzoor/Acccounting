                        ...
                        <td class="border-top-0 p-0" colspan="4">
                            <table class="w-100">
                                ...
                                <tbody>
                                    ...
                                    <tr v-for="(row_tax, row_tax_index) in row.account_ids"
                                    :index="row_tax_index">
                                        <td colspan="2" class="pl-0 pb-0 border-0" :class="{'pb-2' : !row.add_tax}">
                                            <div>
                                                <div style="float: left; margin-top: 15px; right: 43%; position: absolute;">
                                                ...
                                                @stack('accounts_input_start')
                                                <akaunting-select
                                                    class="mb-0 select-account"
                                                    :form-classes="[{'has-error': form.errors.has('items.' + index + '.accounts') }]"
                                                    :icon="''"
                                                    :title="''"
                                        ...
                                        <td colspan="2" class="pl-0 border-0">
                                            <div>
                                                ...
                                                <akaunting-select
                                                    ...
                                                    :title="''"
                                                    :placeholder="'{{ trans('general.form.select.field', ['field' => trans_choice('general.accounts', 1)]) }}'"
                                                    :name="'items.' + index + '.accounts.999'"
                                                    :options="{{ json_encode($accounts->pluck('name', 'id')) }}"
                                                   
                                                    :value="tax_id"
                                                    :add-new="{{ json_encode([
                                                        'status' => true,
                                                        'text' => trans('general.add_new'),
                                                        'path' => route('modals.accounts.create'),
                                                        'type' => 'modal',
                                                        'field' => [
                                                            'key' => 'id',
                                                            'value' => 'name'
