...
return [
    ...
    'install'               => 'Inštalovať',
    'buy_now'               => 'Kúpiť teraz',
    'token_link'            => '<a href="https://my.com/tokens" target="_blank">Kliknite tu</a> a získajte Váš API token.',
    'no_apps'               => 'Neexistujú žiadne aplikácie v tejto kategórii zatiaľ.',
    'developer'             => 'Ste vývojár? tu <a href="https://my.com/blog/akaunting-app-store" target="_blank"></a> sa môžete naučiť, ako vytvoriť aplikáciu a začať predávať ešte dnes!',
