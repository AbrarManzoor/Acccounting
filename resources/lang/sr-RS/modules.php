...
return [
    ...
    'install'               => 'Инсталирај',
    'buy_now'               => 'Купи одмах',
    'token_link'            => '<a href="https://my.com/tokens" target="_blank">Кликните овде</a> да бисте добили свој API token.',
    'no_apps'               => 'У овој категорији још нема апликација.',
    'developer'             => 'Јеси ли програмер? <a href="https://my.com/blog/akaunting-app-store" target="_blank">Овде </a> можете научити како креирати апликацију и можеш да почнеш да је продајеш!',
