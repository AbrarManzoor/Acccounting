...
return [
    ...
    'api_key_link'          => '<a class="text-red" href="https://my.com/profile" target="_blank">Нажмите здесь</a>, чтобы получить ваш ключ API.',
    'no_apps'               => 'В этой категории еще нет приложений.',
    'developer'             => 'Вы разработчик? <a href="https://my.com/developers" target="_blank">Здесь</a> вы можете узнать, как создать приложение и начать продавать уже сегодня!',
